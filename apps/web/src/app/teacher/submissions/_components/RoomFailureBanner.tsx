 ...
 * cùng một phòng, >=2 phiên, trải >=2 lớp. Lúc đó vấn đề gần như chắc chắn là
...
export function RoomFailureBanner({
  room, sessionCount, classCount,
}: { room: string; sessionCount: number; classCount: number }) {
  return (
    <div
      role="status"
    ...
    >
      ...
      <span>
        ...
        <strong>{room}</strong>, trải {classCount} lớp khác nhau — nhiều khả năng là sự cố

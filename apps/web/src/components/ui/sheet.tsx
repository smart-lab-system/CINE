...
// Built on the same Dialog primitive as components/ui/dialog.tsx (a Sheet
// IS a Dialog, just anchored to a screen edge instead of centered) — no
// separate Radix package needed.
